...
export class OptimizeItemDto {
  @ApiProperty({
    ...
    description: 'Item ID from your catalog',
  })
  @IsUUID()
  id!: string;
...
export class OptimizeRequestDto {
  @ApiProperty({
    ...
    description: 'Items to optimize packing for',
  })
  @IsArray()
  @ArrayMinSize(1)
  @ArrayMaxSize(500)
  ...
  @ApiPropertyOptional({
    default: 10,
    description: 'Maximum number of boxes to use',
  })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    default: true,
    description: 'Include flat-rate box comparison',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    type: [String],
    description:
      'Additional box type IDs to consider (besides tenant defaults)',
  })
  @IsOptional()
  @IsArray()
  @IsUUID('4', { each: true })
